...
class RefreshCoordinator:
    ...
    def dashboard(self) -> dict:
        ...
        dashboard['collection_windows'] = {'jira_mentions_days': self.settings.jira.mention_reply_days, 'jira_participation_days': self.settings.jira.participation_days, 'ado_mentions_days': self.settings.azure_devops.mention_reply_days, 'jira_query_cap': self.settings.jira.max_candidates_per_query, 'ado_item_cap': self.settings.azure_devops.max_work_items, 'ado_comment_cap': self.settings.azure_devops.max_comment_candidates}
